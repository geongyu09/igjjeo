...
export default function SubscriptionsPage() {
  ...
  const [subs, setSubs] = useState<Record<OutletKey, boolean>>(
  ...
  return (
    <MobileScreen header={<ScreenHeader title="언론사 구독" onBack={back} />}>
      <div className={styles.body}>
        <p className={styles.intro}>
          구독한 언론사 기사가 피드 위쪽에 더 자주 떠요.
        </p>
        ...
        <div className={styles.notice}>
          ...
          <div>
            구독 목록은 프로필에 공개돼요.{" "}
            <b>&ldquo;너 아직도 데일리쇼크 구독해?&rdquo;</b>
          </div>
        </div>
      </div>
    </MobileScreen>
